#!/usr/bin/python3
"""This module define the class to manage db_storage for hbnb clone"""
import os
...
class DBStorage:
    """clas manage db_storage of hbnb models in a SQL database"""
    __engine = None
    __session = None

    def __init__(self):
        """Initialie the SQL database storage"""
